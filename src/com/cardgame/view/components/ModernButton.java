...
public class ModernButton extends JComponent {
    ...
    private Color selectedColor = new Color(82, 107, 254);
    ...
    public void render(Graphics g, Rectangle bounds, boolean selected) {
        this.selected = selected;
        render(g, bounds.x, bounds.y, bounds.width, bounds.height);
    }
